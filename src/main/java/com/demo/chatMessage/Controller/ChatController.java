...
public class ChatController {
	...
	public void processMessage(@Payload ChatMessage chatMessage) {
		...
		messageTemplate.convertAndSendToUser(chat.getRecipientId(),"/queue/messages",
	...
	public ResponseEntity<List<ChatMessage>> findChat(@PathVariable String senderId,@PathVariable String recipientId){
